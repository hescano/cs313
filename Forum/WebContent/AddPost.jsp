					...
					<div id="loginbox" style="margin-top: 50px;"
						...
						<div class="panel panel-info">
							<div class="panel-heading">
								<div class="panel-title">Post Forum Message</div>
							</div>

							<div style="padding-top: 30px" class="panel-body">
								<div style="display: none" id="login-alert"
									class="alert alert-danger col-sm-12"></div>
								<form id="addPost" class="form-horizontal" role="form"
									action="AddForumMessage" method="post">
									<textarea class="form-control" name="txtMessage" rows="3"></textarea>
									<div style="margin-top: 10px" class="form-group">
										<div class="col-sm-12 controls">
											<button id="btn-login" type="submit" class="btn btn-primary">Post to Forum
											</button>
											<a href="showForum">Go back to Forum</a>
										</div>
									</div>
								</form>
							</div>
